...
export const ReceptionistNavbar = () => {
  ...
  return (
    <header className="h-14 bg-white border-b border-neutral-200 flex items-center justify-between px-6 shrink-0 relative">
            ...
            <div className="p-6 h-[350px] overflow-y-auto">
              {!globalSearchQuery.trim() ? (
                ...
                <div className="space-y-2">
                  ...
                  {!searchingGlobal && searchResults.length === 0 && (
                    <div className="text-center py-6 border border-dashed border-neutral-200 rounded-xl bg-neutral-50/50 space-y-3">
